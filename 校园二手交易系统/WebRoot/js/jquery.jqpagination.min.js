 ...
 */(function(e) {
	...
	e.jqPagination = function(t, n) {
		...
		r.setPage = function(e, t) {
			...
			var n = parseInt(r.options.current_page, 10), i = parseInt(
		...
		r.callMethod = function(t, n, i) {
			...
			case "option":
				if (i === undefined && typeof n != "object")
					return r.options[n];
				var s = {
					trigger : !0
				}, o = !1;
				...
				var u = s.trigger === !1;
				s.current_page !== undefined
						&& (o = r.setPage(s.current_page, u));
				s.max_page !== undefined && (o = r.setMaxPage(s.max_page, u));
				o === !1
						&& console
								.error("jqPagination: cannot get / set option "
										+ n);
				return o;
			case "destroy":
	...
	e.fn.jqPagination = function() {
		...
		if (typeof r[0] == "string") {
			r[2] === undefined ? i = n.first().data("jqPagination").callMethod(
					r[0], r[1]) : n.each(function() {
